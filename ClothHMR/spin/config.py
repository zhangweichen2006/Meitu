...
H36M_ROOT = '/home/gpu/data/human3.6'
LSP_ROOT = '/home/gpu/data/lsp/lsp_dataset'
LSP_ORIGINAL_ROOT = '/home/gpu/data/lsp/lsp_dataset_original'
UPI_S1H_ROOT = '/home/gpu/data/up_3d2'
MPII_ROOT = '/home/gpu/data/mpii'
COCO_ROOT = '/home/gpu/data/coco'
UP_3D_ROOT = '/home/gpu/data/up-3d'

# Output folder to save test/train npz files
DATASET_NPZ_PATH = '/home/gpu/data/GCMR/dataset'
...
DATASET_FILES = [ {'h36m-p1': join(DATASET_NPZ_PATH, 'extras', 'h36m_valid_protocol1.npz'),
                  ...
                  {'lsp-orig': join(DATASET_NPZ_PATH, 'extras', 'lsp_dataset_original_train.npz'),
                   ...
                   'h36m-p1': join(DATASET_NPZ_PATH, 'extras', 'h36m_valid_protocol1.npz'),
...
CUBE_PARTS_FILE = '/data/spin/data/cube_parts.npy'
JOINT_REGRESSOR_TRAIN_EXTRA = '/media/bbnc/FE345AE3345A9F09/loose_cloth/clothHMR/spin/data/J_regressor_extra.npy'
JOINT_REGRESSOR_H36M = '/media/bbnc/FE345AE3345A9F09/loose_cloth/clothHMR/spin/data/J_regressor_h36m.npy'
VERTEX_TEXTURE_FILE = '/data/spin/data/vertex_texture.npy'
STATIC_FITS_DIR = '/data/spin/data/static_fits'
SMPL_MEAN_PARAMS = '/media/bbnc/FE345AE3345A9F09/loose_cloth/clothHMR/spin/data/smpl_mean_params.npz'
SMPL_MODEL_DIR = '/media/star/2023/CODE/GYQ/SPIN-master/data/smpl/models'
"""
