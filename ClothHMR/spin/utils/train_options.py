...
class TrainOptions():
    ...
    def __init__(self):
        ...
        req.add_argument('--name', default="train_example", help='Name of the experiment')
        ...
        io.add_argument('--pretrained_checkpoint', default="/media/gpu/GYQ-KESU/code/code/SPIN-master/data/model_checkpoint.pt", help='Load a pretrained checkpoint at the beginning training')

        dataloading = self.parser.add_argument_group('Data Loading')
        dataloading.add_argument('--dataset_dir', default="/media/amax/4C76448F76447C28/TH2Render", type=str, help='dataset directory')
        dataloading.add_argument('--view_num_per_item', type=int, default=360, help='view_num_per_item')
