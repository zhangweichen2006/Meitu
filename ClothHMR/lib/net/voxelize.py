...
if os.path.exists('/media/amax/4C76448F76447C28/LYH/code/PaMIR-main/networks/neural_voxelization_layer/cuda/voxelize_cuda.cpp') and os.path.exists('/media/amax/4C76448F76447C28/LYH/code/PaMIR-main/networks/neural_voxelization_layer/cuda/voxelize_cuda.cu'):
    voxelize_cuda = load(
            name='voxelize_cuda',
            sources=['/media/amax/4C76448F76447C28/LYH/code/PaMIR-main/networks/neural_voxelization_layer/cuda/voxelize_cuda.cpp', '/media/amax/4C76448F76447C28/LYH/code/PaMIR-main/networks/neural_voxelization_layer/cuda/voxelize_cuda.cu'],
