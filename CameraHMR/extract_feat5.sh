...
CUDA_VISIBLE_DEVICES=5 python SapiensLite/demo/vis_normal.py \
    ...
    --input data/training-images/20221010_3_1000_batch01hand_6fps \
    --output_root data/training-images-sapiens-normals-OrgPadCrop-local/20221010_3_1000_batch01hand_6fps \
    --batch_size 1
