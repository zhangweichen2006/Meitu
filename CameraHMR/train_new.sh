...
CUDA_VISIBLE_DEVICES=3,4,5,6 python train.py data=traintest experiment=camerahmr_multi exp_name=train_run3  trainer=ddp trainer.accelerator=gpu trainer.devices=4
