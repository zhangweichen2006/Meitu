...
CUDA_VISIBLE_DEVICES=3,4,5,6 python train.py data=train experiment=camerahmr exp_name=train_run2  trainer=ddp trainer.accelerator=gpu trainer.devices=4
